...
function Cart() {
    ...
    const {decreasQty,increasQty,clearCart,getCartContext,removeItemContext } = useContext(CartContext);
    
    const getCart = async () => {
        const res = await getCartContext();
        return res;
    }
    const increas = async (productId) => {
        const res = await increasQty(productId);
        return res;
    }
    const decreas = async (productId) => {
        const res = await decreasQty(productId);
        return res;
    }
            ...
            <div className="container">
                <div className="row">
                        ...
                        <div className="products" id="products">
                            ...
                            {data?.products ? (data.products.map((product) =>
                                <div className="item">
                                    ...
                                    <div className="quantity">
                                        <button onClick={()=>decreas(product.productId)}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={16}
                                                height={17}
                                        ...
                                        <button onClick={()=>increas(product.productId)}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width={16}
                                                height={17}
                    ...
                    <div className='clear-all'>
                        <button className='btn btn-info' onClick={clearAllCart}>Clear All</button>
                    </div>
                    <div className="row">
                        <h2>Have a coupon ?</h2>
